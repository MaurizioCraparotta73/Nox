...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BVOxcYB_.mjs");
...
var manifest = { "6a0d1adc9e7c5e1fb847e6b66038c4b01e05130b71c399ba5ae3f8c9edd425bd": {
	functionName: "getForecast_createServerFn_handler",
	importer: () => import("./get-forecast-CRDUnynr.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Ef7_fTlW.mjs").then((n) => n.t),
